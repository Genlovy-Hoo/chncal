...
class DocTests(unittest.TestCase):
    def test_same_code_as_readme_english(self):
        ...
        from chncal import is_holiday, is_workday
        ...
        import chncal as calendar  # 也可以这样 import
        ...
        assert chncal.is_in_lieu(datetime.date(2006, 2, 1)) is False
        assert chncal.is_in_lieu(datetime.date(2006, 2, 2)) is True
